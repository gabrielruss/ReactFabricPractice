...
var IconBasicExampleCode = require('./examples/Icon.Basic.Example.tsx');
var IconColorExampleCode = require('./examples/Icon.Color.Example.tsx');
var IconImageSheetExampleCode = require('./examples/Icon.ImageSheet.Example.tsx');
var IconPage = (function (_super) {
    __extends(IconPage, _super);
    function IconPage() {
        var _this = _super.call(this) || this;
        _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Icon');
        return _this;
    }
    IconPage.prototype.render = function () {
        return (React.createElement(index_1.ComponentPage, { title: 'Icon', componentName: 'IconExample', exampleCards: React.createElement("div", null,
                React.createElement(index_1.ExampleCard, { title: 'Icon', code: IconBasicExampleCode },
                    React.createElement(Icon_Basic_Example_1.IconBasicExample, null)),
                React.createElement(index_1.ExampleCard, { title: 'Icon with custom color', code: IconColorExampleCode },
                    React.createElement(Icon_Color_Example_1.IconColorExample, null)),
                React.createElement(index_1.ExampleCard, { title: 'Icon using image sheet', code: IconImageSheetExampleCode },
                    React.createElement(Icon_ImageSheet_Example_1.IconImageSheetExample, null))), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Icon' }), overview: React.createElement("div", null,
                ...
                React.createElement("ul", null,
                    ...
                    React.createElement("li", null, "Use photos or long sentences as icons."))), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
    };
    return IconPage;
}(React.Component));
