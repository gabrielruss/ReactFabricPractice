...
var DetailsListGroupedExample = (function (_super) {
    ...
    DetailsListGroupedExample.prototype.render = function () {
        ...
        return (React.createElement(index_1.Fabric, { className: 'foo' },
            React.createElement(index_1.Button, { onClick: function () { return _this._addItem(); } }, "Add an item"),
            React.createElement(index_1.DetailsList, { items: items, groups: groupBy(items, 'color'), columns: _columns })));
    };
