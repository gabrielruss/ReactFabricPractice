...
var ButtonDefaultExample = (function (_super) {
    ...
    ButtonDefaultExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'ms-BasicButtonsExample' },
            React.createElement(index_1.Label, null, "Default button"),
            React.createElement(index_1.DefaultButton, { "data-automation-id": 'test', disabled: disabled }, "Create account")));
    };
