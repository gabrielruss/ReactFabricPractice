...
var GroupedListPage = (function (_super) {
    ...
    function GroupedListPage() {
        ...
        _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'GroupedList');
        return _this;
    }
    GroupedListPage.prototype.render = function () {
        return (React.createElement(index_1.ComponentPage, { title: 'GroupedList', componentName: 'GroupedListExample', exampleCards: React.createElement("div", null,
                ...
                React.createElement(index_1.ExampleCard, { title: 'GroupedList example with custom header and footer', isOptIn: true, code: GroupedListCustomExampleCode },
                    React.createElement(GroupedList_Custom_Example_1.GroupedListCustomExample, null))), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'GroupedList' }), overview: React.createElement("p", null, "Allows you to render a set of items as multiple lists with various grouping properties."), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
    };
