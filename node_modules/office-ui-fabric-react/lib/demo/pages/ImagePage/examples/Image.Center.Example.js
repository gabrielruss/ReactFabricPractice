...
var ImageCenterExample = (function (_super) {
    ...
    ImageCenterExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(index_1.Label, null, "The image is larger than the frame, so all sides are cropped to center the image."),
            React.createElement(index_1.Image, __assign({}, imageProps, { src: 'http://placehold.it/800x300' })),
            React.createElement("br", null),
            React.createElement(index_1.Label, null, "The image is smaller than the frame, so there is empty space within the frame. The image is centered in the available space."),
