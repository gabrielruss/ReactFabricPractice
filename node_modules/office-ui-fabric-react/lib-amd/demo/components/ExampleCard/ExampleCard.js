...
define(["require", "exports", "react", "../../../Utilities", "../../../Button", "./ExampleCard.scss"], function (require, exports, React, Utilities_1, Button_1) {
    "use strict";
        ...
        ExampleCard.prototype.render = function () {
            ...
            return (React.createElement("div", { className: rootClass },
                React.createElement("div", { className: 'ExampleCard-header' },
                    ...
                    React.createElement("div", { className: 'ExampleCard-toggleButtons ms-font-l' }, code ? (React.createElement(Button_1.Button, { buttonType: Button_1.ButtonType.icon, icon: 'Embed', onClick: this._onToggleCodeClick, className: Utilities_1.css('ExampleCard-codeButton', { 'is-active': isCodeVisible }) }, this.state.isCodeVisible ? 'Hide code' : 'Show code')) : (null))),
