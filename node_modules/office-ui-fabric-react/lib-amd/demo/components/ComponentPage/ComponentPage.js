...
define(["require", "exports", "react", "../../../Utilities", "../../../Link", "./ComponentPage.scss"], function (require, exports, React, Utilities_1, Link_1) {
    "use strict";
        ...
        ComponentPage.prototype._navigationLinks = function () {
            ...
            if (bestPractices && dos && donts) {
                links.push(React.createElement("div", { className: 'ComponentPage-navLink', key: 'nav-link' },
                    React.createElement(Link_1.Link, { href: route + '#Best Practices' }, "Best Practices")));
            }
            return (React.createElement("div", { className: 'ComponentPage-navigation' },
                React.createElement("div", { className: 'ComponentPage-navLink' },
                    React.createElement(Link_1.Link, { href: route + '#Overview' }, "Overview")),
                links,
                React.createElement("div", { className: 'ComponentPage-navLink' },
                    React.createElement(Link_1.Link, { href: route + '#Variants' }, "Variants")),
                React.createElement("div", { className: 'ComponentPage-navLink' },
                    React.createElement(Link_1.Link, { href: route + '#Implementation' }, "Implementation"))));
        };
