...
define(["require", "exports", "react", "../../components/index", "./examples/Panel.SmallRight.Example", "./examples/Panel.SmallLeft.Example", "./examples/Panel.SmallFluid.Example", "./examples/Panel.Medium.Example", "./examples/Panel.Large.Example", "./examples/Panel.LargeFixed.Example", "./examples/Panel.ExtraLarge.Example", "./examples/Panel.LightDismiss.Example", "./examples/Panel.NonModal.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Panel_SmallRight_Example_1, Panel_SmallLeft_Example_1, Panel_SmallFluid_Example_1, Panel_Medium_Example_1, Panel_Large_Example_1, Panel_LargeFixed_Example_1, Panel_ExtraLarge_Example_1, Panel_LightDismiss_Example_1, Panel_NonModal_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var PanelPage = (function (_super) {
        ...
        function PanelPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Panel');
            return _this;
        }
        PanelPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Panel', componentName: 'PanelExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'Panel - Non-Modal', code: PanelNonModalExampleCode },
                        React.createElement(Panel_NonModal_Example_1.PanelNonModalExample, null))), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Panel' }), overview: React.createElement("div", null,
