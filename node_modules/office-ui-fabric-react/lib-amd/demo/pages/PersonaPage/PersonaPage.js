...
define(["require", "exports", "react", "../../components/index", "./examples/Persona.Initials.Example", "./examples/Persona.Basic.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Persona_Initials_Example_1, Persona_Basic_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var PersonaPage = (function (_super) {
        ...
        function PersonaPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Persona');
            return _this;
        }
        PersonaPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Persona', componentName: 'PersonaExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'Persona in initials', code: PersonaInitialsExampleCode },
                        React.createElement(Persona_Initials_Example_1.PersonaInitialsExample, null))), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Persona' }), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        React.createElement("li", null, "Change the values of the color swatches in high contrast mode. "))), related: React.createElement("a", { href: 'https://dev.office.com/fabric-js/Components/Persona/Persona.html' }, "Fabric JS"), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
        return PersonaPage;
    }(React.Component));
