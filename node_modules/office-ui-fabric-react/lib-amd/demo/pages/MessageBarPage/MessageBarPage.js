...
define(["require", "exports", "react", "../../components/index", "./examples/MessageBar.Basic.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, MessageBar_Basic_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var MessageBarPage = (function (_super) {
        ...
        function MessageBarPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'MessageBar');
            return _this;
        }
        MessageBarPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'MessageBar', componentName: 'MessageBarExample', exampleCards: React.createElement(index_1.ExampleCard, { title: 'Various MessageBar types', code: MessageBarBasicExampleCode },
                    React.createElement(MessageBar_Basic_Example_1.MessageBarBasicExample, null)), propertiesTables: React.createElement("div", null,
