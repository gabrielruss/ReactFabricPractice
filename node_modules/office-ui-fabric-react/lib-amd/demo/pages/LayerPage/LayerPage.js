...
define(["require", "exports", "react", "../../components/index", "./examples/Layer.Basic.Example", "./examples/Layer.Hosted.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Layer_Basic_Example_1, Layer_Hosted_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var LayerPage = (function (_super) {
        ...
        function LayerPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Layer');
            return _this;
        }
        LayerPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Layer', componentName: 'LayerExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'Using LayerHost to control projection', code: LayerHostedExampleCode },
                        React.createElement(Layer_Hosted_Example_1.LayerHostedExample, null))), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Layer' }), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        React.createElement("li", null, 'Don\'t use string refs ( ref=\'root\' ).'))), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
        return LayerPage;
    }(React.Component));
