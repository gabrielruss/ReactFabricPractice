...
define(["require", "exports", "react", "../../components/index", "./examples/Link.Basic.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Link_Basic_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var LinkPage = (function (_super) {
        ...
        function LinkPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Link');
            return _this;
        }
        LinkPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Link', componentName: 'LinkExample', exampleCards: React.createElement(index_1.ExampleCard, { title: 'Link', code: LinkBasicExampleCode },
                    React.createElement(Link_Basic_Example_1.LinkBasicExample, null)), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Link' }), overview: React.createElement("div", null,
