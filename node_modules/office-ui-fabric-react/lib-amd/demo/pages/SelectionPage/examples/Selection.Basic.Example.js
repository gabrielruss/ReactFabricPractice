...
define(["require", "exports", "react", "../../../../index", "../../../../components/Check/Check", "../../../../utilities/selection/index", "../../../utilities/data", "./Selection.Example.scss"], function (require, exports, React, index_1, Check_1, index_2, data_1) {
    "use strict";
    var ITEM_COUNT = 100;
    /**
    ...
    var SelectionBasicExample = (function (_super) {
        ...
        function SelectionBasicExample() {
            ...
            _this.state = {
                ...
                selection: new index_2.Selection({ onSelectionChanged: _this._onSelectionChanged }),
