...
define(["require", "exports", "react", "../../components/index", "./examples/Toggle.Basic.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Toggle_Basic_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var TogglePage = (function (_super) {
        ...
        function TogglePage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Toggle');
            return _this;
        }
        TogglePage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Toggle', componentName: 'ToggleExample', exampleCards: React.createElement(index_1.ExampleCard, { title: 'Toggle', code: ToggleBasicExampleCode },
                    React.createElement(Toggle_Basic_Example_1.ToggleBasicExample, null)), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Toggle' }), overview: React.createElement("div", null,
