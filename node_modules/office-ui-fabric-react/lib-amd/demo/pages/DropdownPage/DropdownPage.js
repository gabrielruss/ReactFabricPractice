...
define(["require", "exports", "react", "../../components/index", "./examples/Dropdown.Basic.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Dropdown_Basic_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var DropdownPage = (function (_super) {
        ...
        function DropdownPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Dropdown');
            return _this;
        }
        DropdownPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Dropdown', componentName: 'DropdownExample', exampleCards: React.createElement(index_1.ExampleCard, { title: 'Dropdown', code: DropdownBasicExampleCode },
                    React.createElement(Dropdown_Basic_Example_1.DropdownBasicExample, null)), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Dropdown' }), overview: React.createElement("div", null,
