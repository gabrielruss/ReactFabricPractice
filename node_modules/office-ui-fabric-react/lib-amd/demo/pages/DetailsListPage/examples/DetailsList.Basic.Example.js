        ...
        DetailsListBasicExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                ...
                React.createElement(index_1.MarqueeSelection, { selection: this._selection },
                    React.createElement(index_1.DetailsList, { items: items, setKey: 'set', selection: this._selection, selectionPreservedOnEmptyClick: true, onItemInvoked: function (item) { return alert("Item invoked: " + item.name); }, onRenderItemColumn: this._onRenderItemColumn }))));
        };
