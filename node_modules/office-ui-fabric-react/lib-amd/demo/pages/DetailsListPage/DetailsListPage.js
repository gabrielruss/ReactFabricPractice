...
define(["require", "exports", "react", "../../../index", "../../components/index", "../../utilities/pageroute", "../../components/App/AppState", "./examples/DetailsList.Basic.Example", "./examples/DetailsList.CustomColumns.Example", "./examples/DetailsList.CustomRows.Example", "./examples/DetailsList.CustomGroupHeaders.Example", "./examples/DetailsList.Advanced.Example", "./examples/DetailsList.Grouped.Example"], function (require, exports, React, index_1, index_2, pageroute_1, AppState_1, DetailsList_Basic_Example_1, DetailsList_CustomColumns_Example_1, DetailsList_CustomRows_Example_1, DetailsList_CustomGroupHeaders_Example_1, DetailsList_Advanced_Example_1, DetailsList_Grouped_Example_1) {
    "use strict";
    ...
    var DetailsListGroupedExampleCode = require('./examples/DetailsList.Grouped.Example.tsx');
    var DetailsListPage = (function (_super) {
        __extends(DetailsListPage, _super);
        function DetailsListPage() {
            var _this = _super.call(this) || this;
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'DetailsList');
            return _this;
        }
        DetailsListPage.prototype.render = function () {
            return (React.createElement(index_2.ComponentPage, { title: 'DetailsList', componentName: 'DetailsListExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_2.ExampleCard, { title: 'Simple Grouped DetailsList', isOptIn: true, code: DetailsListGroupedExampleCode },
                    ...
                    React.createElement(index_2.ExampleCard, { title: 'Advanced DetailsList of 5000 items, variable row heights', isOptIn: true, code: DetailsListAdvancedExampleCode },
                        React.createElement(DetailsList_Advanced_Example_1.DetailsListAdvancedExample, null))), propertiesTables: React.createElement(index_2.PropertiesTableSet, { componentName: 'DetailsList' }), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Make columns so narrow that it truncates the information in typical cases."))), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
