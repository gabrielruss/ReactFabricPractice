...
define(["require", "exports", "react", "../../components/index", "./examples/Spinner.Basic.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Spinner_Basic_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var SpinnerPage = (function (_super) {
        ...
        function SpinnerPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Spinner');
            return _this;
        }
        SpinnerPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Spinner', componentName: 'SpinnerExample', exampleCards: React.createElement(index_1.ExampleCard, { title: 'Various Spinner Types', code: SpinnerBasicExampleCode },
                    React.createElement(Spinner_Basic_Example_1.SpinnerBasicExample, null)), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Spinner' }), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Don't include more than a few words when paired with a Spinner."))), related: React.createElement("a", { href: 'https://dev.office.com/fabric-js/Components/Spinner/Spinner.html' }, "Fabric JS"), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
        return SpinnerPage;
    }(React.Component));
