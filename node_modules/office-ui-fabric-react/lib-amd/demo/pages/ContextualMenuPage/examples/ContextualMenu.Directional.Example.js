        ...
        ContextualMenuDirectionalExample.prototype.render = function () {
            ...
            return (React.createElement("div", { className: 'ms-ContextualMenuDirectionalExample' },
                React.createElement("div", { className: 'ms-ContextualMenuDirectionalExample-configArea' },
                    ...
                    React.createElement(index_1.Checkbox, { label: 'Fix Edge', checked: edgeFixed, onChange: this._onFixEdgeChange }),
                ...
                isContextualMenuVisible ? (React.createElement(index_1.ContextualMenu, { target: this.refs.menuButton, isBeakVisible: isBeakVisible, directionalHint: directionalHint, gapSpace: gapSpace, beakWidth: beakWidth, directionalHintFixed: edgeFixed, items: [
                        {
                            key: 'newItem',
                            name: 'New',
                            icon: 'Add',
