...
define(["require", "exports", "react", "../../components/index", "./examples/ContextualMenu.Basic.Example", "./examples/ContextualMenu.Checkmarks.Example", "./examples/ContextualMenu.Directional.Example", "./examples/ContextualMenu.Customization.Example", "./examples/ContextualMenu.Header.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, ContextualMenu_Basic_Example_1, ContextualMenu_Checkmarks_Example_1, ContextualMenu_Directional_Example_1, ContextualMenu_Customization_Example_1, ContextualMenu_Header_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var ContextualMenuHeaderExampleCode = require('./examples/ContextualMenu.Header.Example.tsx');
    var ContextualMenuPage = (function (_super) {
        __extends(ContextualMenuPage, _super);
        function ContextualMenuPage() {
            var _this = _super.call(this) || this;
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'ContextualMenu');
            return _this;
        }
        ContextualMenuPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'ContextualMenu', componentName: 'ContextualMenuExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'ContextualMenu header example', code: ContextualMenuHeaderExampleCode },
                        React.createElement(ContextualMenu_Header_Example_1.ContextualMenuHeaderExample, null))), propertiesTables: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Create submenus of submenus."))), related: React.createElement("a", { href: 'https://dev.office.com/fabric-js/Components/ContextualMenu/ContextualMenu.html' }, "Fabric JS"), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
