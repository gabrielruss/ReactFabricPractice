...
define(["require", "exports", "react", "../../components/index", "./examples/Pivot.Basic.Example", "./examples/Pivot.IconCount.Example", "./examples/Pivot.Large.Example", "./examples/Pivot.Tabs.Example", "./examples/Pivot.TabsLarge.Example", "./examples/Pivot.Fabric.Example", "./examples/Pivot.OnChange.Example", "./examples/Pivot.Remove.Example", "./examples/Pivot.Override.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Pivot_Basic_Example_1, Pivot_IconCount_Example_1, Pivot_Large_Example_1, Pivot_Tabs_Example_1, Pivot_TabsLarge_Example_1, Pivot_Fabric_Example_1, Pivot_OnChange_Example_1, Pivot_Remove_Example_1, Pivot_Override_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var PivotIconCountExampleCode = require('./examples/Pivot.IconCount.Example.tsx');
    var PivotOverrideExampleCode = require('./examples/Pivot.Override.Example.tsx');
    var PivotPage = (function (_super) {
        __extends(PivotPage, _super);
        function PivotPage() {
            var _this = _super.call(this) || this;
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Pivot');
            return _this;
        }
        PivotPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Pivot', componentName: 'PivotExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'Count and Icon', code: PivotIconCountExampleCode },
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'Override selected item', code: PivotOverrideExampleCode },
                        React.createElement(Pivot_Override_Example_1.PivotOverrideExample, null))), propertiesTables: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Don\u2019t use the Pivot to link to hidden content."))), related: React.createElement("a", { href: 'https://dev.office.com/fabric-js/Components/Pivot/Pivot.html' }, "Fabric JS"), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
        return PivotPage;
    }(React.Component));
