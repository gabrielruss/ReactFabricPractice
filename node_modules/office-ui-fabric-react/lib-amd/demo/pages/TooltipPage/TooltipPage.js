...
define(["require", "exports", "react", "../../../index", "../../components/index", "./examples/Tooltip.Bottom.Example", "./examples/Tooltip.Basic.Example", "../../utilities/pageroute", "../../components/App/AppState", "./TooltipPage.scss"], function (require, exports, React, index_1, index_2, Tooltip_Bottom_Example_1, Tooltip_Basic_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var TooltipPage = (function (_super) {
        ...
        function TooltipPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Tooltip');
            return _this;
        }
        TooltipPage.prototype.render = function () {
            return (React.createElement(index_2.ComponentPage, { title: 'Tooltip', componentName: 'TooltipExample', exampleCards: React.createElement(index_1.LayerHost, null,
                    ...
                    React.createElement(index_2.ExampleCard, { title: 'Tooltip Bottom Direction. No delay', code: TooltipBottomExampleCode },
                        React.createElement(Tooltip_Bottom_Example_1.TooltipBottomExample, null))), propertiesTables: React.createElement(index_2.PropertiesTableSet, { componentName: 'Tooltip' }), overview: React.createElement("div", null,
