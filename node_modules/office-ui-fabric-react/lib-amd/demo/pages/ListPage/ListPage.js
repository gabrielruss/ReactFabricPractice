...
define(["require", "exports", "react", "../../components/index", "./examples/List.Basic.Example", "./examples/List.Mail.Example", "./examples/List.Grid.Example", "../../utilities/data", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, List_Basic_Example_1, List_Mail_Example_1, List_Grid_Example_1, data_1, pageroute_1, AppState_1) {
    ...
    var ListPage = (function (_super) {
        ...
        function ListPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'List');
            if (!_cachedItems) {
        ...
        ListPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'List', componentName: 'ListExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'Fixed list of 5000 email tiles', isOptIn: true, code: ListMailExampleCode },
                        React.createElement(List_Mail_Example_1.ListMailExample, { items: _cachedItems }))), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'List' }), overview: React.createElement("div", null,
