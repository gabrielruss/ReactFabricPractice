...
define(["require", "exports", "react", "../../components/index", "../../components/App/AppState", "../../utilities/pageroute", "./examples/Overlay.Dark.Example", "./examples/Overlay.Light.Example"], function (require, exports, React, index_1, AppState_1, pageroute_1, Overlay_Dark_Example_1, Overlay_Light_Example_1) {
    "use strict";
    ...
    var OverlayPage = (function (_super) {
        ...
        function OverlayPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Overlay');
            return _this;
        }
        OverlayPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Overlay', componentName: 'OverlayExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'Dark', code: OverlayDarkExampleCode },
                        React.createElement(Overlay_Dark_Example_1.OverlayDarkExample, null))), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Overlay' }), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        React.createElement("li", null, "Use an Overlay when you want the user to interact with the UI that is being covered."))), related: React.createElement("a", { href: 'https://dev.office.com/fabric-js/Components/Overlay/Overlay.html' }, "Fabric JS"), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
        return OverlayPage;
    }(React.Component));
