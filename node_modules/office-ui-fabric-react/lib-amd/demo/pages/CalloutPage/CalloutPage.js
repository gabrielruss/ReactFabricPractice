...
define(["require", "exports", "react", "../../components/index", "../CommandBarPage/examples/data", "./examples/Callout.Basic.Example", "./examples/Callout.Nested.Example", "./examples/Callout.Directional.Example", "./examples/Callout.Cover.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, data_1, Callout_Basic_Example_1, Callout_Nested_Example_1, Callout_Directional_Example_1, Callout_Cover_Example_1, pageroute_1, AppState_1) {
    ...
    var CalloutPage = (function (_super) {
        ...
        function CalloutPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Callout');
            return _this;
        }
        CalloutPage.prototype.render = function () {
            ...
            return (React.createElement(index_1.ComponentPage, { title: 'Callout', componentName: 'CalloutExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Don\u2019t show Callouts on hidden elements."))), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
        return CalloutPage;
    }(React.Component));
