...
define(["require", "exports", "react", "../../components/index", "./examples/TextField.Basic.Example", "./examples/TextField.ErrorMessage.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, TextField_Basic_Example_1, TextField_ErrorMessage_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var TextFieldPage = (function (_super) {
        ...
        function TextFieldPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'TextField');
            return _this;
        }
        TextFieldPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'TextField', componentName: 'TextFieldExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'TextField error message variations', code: TextFieldErrorMessageExampleCode },
                        React.createElement(TextField_ErrorMessage_Example_1.TextFieldErrorMessageExample, null))), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'TextField' }), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Don\u2019t occlude the entry or allow entry when the active content is not visible."))), related: React.createElement("a", { href: 'https://dev.office.com/fabric-js/Components/TextField/TextField.html' }, "Fabric JS"), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
