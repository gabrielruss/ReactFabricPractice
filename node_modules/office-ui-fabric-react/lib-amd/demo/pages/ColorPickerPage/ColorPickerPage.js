    ...
    var ColorPickerPage = (function (_super) {
        ...
        ColorPickerPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'ColorPicker', componentName: 'ColorPickerExample', exampleCards: React.createElement(index_1.ExampleCard, { title: 'ColorPicker', code: ColorPickerBasicExampleCode },
                    React.createElement(ColorPicker_Basic_Example_1.ColorPickerBasicExample, null)), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'ColorPicker' }), overview: React.createElement("div", null, "ColorPicker is used to allow a user to select a color"), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
