...
define(["require", "exports", "react", "../../components/index", "./examples/Nav.Basic.Example", "./examples/Nav.FabricDemoApp.Example", "./examples/Nav.Nested.Example", "./examples/Nav.ByKeys.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Nav_Basic_Example_1, Nav_FabricDemoApp_Example_1, Nav_Nested_Example_1, Nav_ByKeys_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var NavPage = (function (_super) {
        ...
        function NavPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Checkbox');
            return _this;
        }
        NavPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Nav', componentName: 'NavExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'Nav bar of links each with unique keys and empty urls', code: NavByKeysExampleCode },
                        React.createElement(Nav_ByKeys_Example_1.NavByKeysExample, null))), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Nav' }), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Include actions. You may reserve a space for actions, if you keep them well separated from the main Nav and their appearance makes it obvious that tapping them will execute a command instead of navigating."))), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
        return NavPage;
    }(React.Component));
