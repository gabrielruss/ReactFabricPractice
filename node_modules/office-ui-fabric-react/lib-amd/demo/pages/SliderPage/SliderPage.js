...
define(["require", "exports", "react", "../../components/index", "./examples/Slider.Basic.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Slider_Basic_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var SliderPage = (function (_super) {
        ...
        SliderPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Slider', componentName: 'SliderExample', exampleCards: React.createElement(index_1.ExampleCard, { title: 'Slider', code: SliderBasicExampleCode },
                    React.createElement(Slider_Basic_Example_1.SliderBasicExample, null)), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Slider' }), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Don\u2019t use for a range of three values or less."))), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
        return SliderPage;
    }(React.Component));
