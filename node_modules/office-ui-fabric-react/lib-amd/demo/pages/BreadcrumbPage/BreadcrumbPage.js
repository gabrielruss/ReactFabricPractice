...
define(["require", "exports", "react", "../../components/index", "./examples/Breadcrumb.Basic.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Breadcrumb_Basic_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var BreadcrumbPage = (function (_super) {
        ...
        function BreadcrumbPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Breadcrumb');
            return _this;
        }
        BreadcrumbPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Breadcrumb', componentName: 'BreadcrumbExample', exampleCards: React.createElement(index_1.ExampleCard, { title: 'Simple breadcrumb', code: BreadcrumbBasicExampleCode },
                    React.createElement(Breadcrumb_Basic_Example_1.BreadcrumbBasicExample, null)), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Breadcrumb' }), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        React.createElement("li", null, "Don't use Breadcrumbs as a primary way to navigate an app or site."))), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
