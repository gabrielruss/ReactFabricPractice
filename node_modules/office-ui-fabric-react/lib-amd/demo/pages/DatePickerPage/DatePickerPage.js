        ...
        DatePickerPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'DatePicker', componentName: 'DatePickerExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'DatePicker allows input date string', code: DatePickerInputExampleCode },
                        React.createElement(DatePicker_Input_Example_1.DatePickerInputExample, null))), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'DatePicker' }), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "The flyout selector is a light dismiss control. Don't modify this behavior in any way."))), related: React.createElement("a", { href: 'https://dev.office.com/fabric-js/Components/DatePicker/DatePicker.html' }, "Fabric JS"), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
