...
define(["require", "exports", "react", "../../../index", "../../components/index", "./examples/TeachingBubble.Basic.Example", "./examples/TeachingBubble.Condensed.Example", "./examples/TeachingBubble.Illustration.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, index_2, TeachingBubble_Basic_Example_1, TeachingBubble_Condensed_Example_1, TeachingBubble_Illustration_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var TeachingBubblePage = (function (_super) {
        ...
        function TeachingBubblePage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'TeachingBubble');
            return _this;
        }
        TeachingBubblePage.prototype.render = function () {
            return (React.createElement(index_2.ComponentPage, { title: 'TeachingBubble', componentName: 'TeachingBubbleExample', exampleCards: React.createElement(index_1.LayerHost, null,
                    ...
                    React.createElement(index_2.ExampleCard, { title: 'TeachingBubble with Illustration', code: TeachingBubbleIllustrationExampleCode },
                        React.createElement(TeachingBubble_Illustration_Example_1.TeachingBubbleIllustrationExample, null))), propertiesTables: React.createElement(index_2.PropertiesTableSet, { componentName: 'TeachingBubble' }), overview: React.createElement("div", null,
