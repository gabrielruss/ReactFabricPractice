...
define(["require", "exports", "react", "../../components/index", "./examples/data", "./examples/CommandBar.Basic.Example", "./examples/CommandBar.NonFocusable.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, data_1, CommandBar_Basic_Example_1, CommandBar_NonFocusable_Example_1, pageroute_1, AppState_1) {
    ...
    var CommandBarPage = (function (_super) {
        ...
        function CommandBarPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'CommandBar');
            return _this;
        }
        CommandBarPage.prototype.render = function () {
            ...
            return (React.createElement(index_1.ComponentPage, { title: 'CommandBar', componentName: 'CommandBarExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'CommandBar with non-focusable items', code: CommandBarNoFocusableItemsExampleCode },
                        React.createElement(CommandBar_NonFocusable_Example_1.CommandBarNonFocusableItemsExample, null))), propertiesTables: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Display more than 2-3 items on the right side of the bar (or left side in left to right experiences)."))), related: React.createElement("a", { href: 'https://dev.office.com/fabric-js/Components/CommandBar/CommandBar.html' }, "Fabric JS"), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
