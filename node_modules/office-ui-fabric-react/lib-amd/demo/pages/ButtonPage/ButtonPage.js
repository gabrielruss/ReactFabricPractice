...
define(["require", "exports", "react", "../../components/index", "../../../index", "./examples/Button.Default.Example", "./examples/Button.Primary.Example", "./examples/Button.Compound.Example", "./examples/Button.Command.Example", "./examples/Button.Icon.Example", "./examples/Button.Anchor.Example", "./examples/Button.Hero.Example", "./examples/Button.ScreenReader.Example", "../../utilities/pageroute", "../../components/App/AppState", "./examples/Button.Basic.Example.scss"], function (require, exports, React, index_1, index_2, Button_Default_Example_1, Button_Primary_Example_1, Button_Compound_Example_1, Button_Command_Example_1, Button_Icon_Example_1, Button_Anchor_Example_1, Button_Hero_Example_1, Button_ScreenReader_Example_1, pageroute_1, AppState_1) {
    "use strict";
    var ButtonDefaultExampleCode = require('./examples/Button.Default.Example.tsx');
    ...
    var ButtonPage = (function (_super) {
        ...
        function ButtonPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Button');
            return _this;
        }
        ButtonPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Button', componentName: 'ButtonExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'Default Button', code: ButtonDefaultExampleCode },
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Don't put anything other than text in a button."))), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
