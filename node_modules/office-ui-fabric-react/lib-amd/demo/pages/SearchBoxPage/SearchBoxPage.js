...
define(["require", "exports", "react", "../../components/index", "./examples/SearchBox.Small.Example", "./examples/SearchBox.FullSize.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, SearchBox_Small_Example_1, SearchBox_FullSize_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var SearchBoxPage = (function (_super) {
        ...
        function SearchBoxPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'SearchBox');
            return _this;
        }
        SearchBoxPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'SearchBox', componentName: 'SearchBoxExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'SearchBox - No Parent Container', code: SearchBoxFullSizeExampleCode },
                        React.createElement(SearchBox_FullSize_Example_1.SearchBoxFullSizeExample, null))), propertiesTables: React.createElement("div", null,
                    React.createElement(index_1.PropertiesTableSet, { componentName: 'SearchBox' })), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Don't use SearchBox if you cannot reliably provide accurate results."))), related: React.createElement("a", { href: 'https://dev.office.com/fabric-js/Components/SearchBox/SearchBox.html' }, "Fabric JS"), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
