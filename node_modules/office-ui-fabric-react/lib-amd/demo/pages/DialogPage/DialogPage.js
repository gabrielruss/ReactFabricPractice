...
define(["require", "exports", "react", "../../components/index", "./examples/Dialog.Basic.Example", "./examples/Dialog.LargeHeader.Example", "./examples/Dialog.Close.Example", "./examples/Dialog.Blocking.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Dialog_Basic_Example_1, Dialog_LargeHeader_Example_1, Dialog_Close_Example_1, Dialog_Blocking_Example_1, pageroute_1, AppState_1) {
    ...
    var DialogPage = (function (_super) {
        ...
        function DialogPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Dialog');
            return _this;
        }
        DialogPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Dialog', componentName: 'DialogExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.PropertiesTableSet, { componentName: 'Dialog' })), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Don't provide the user with more than 3 buttons."))), related: React.createElement("a", { href: 'https://dev.office.com/fabric-js/Components/Dialog/Dialog.html' }, "Fabric JS"), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
        return DialogPage;
    }(React.Component));
