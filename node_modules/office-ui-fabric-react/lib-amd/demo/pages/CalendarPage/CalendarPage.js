...
define(["require", "exports", "react", "../../components/index", "./examples/Calendar.Button.Example", "./examples/Calendar.Inline.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Calendar_Button_Example_1, Calendar_Inline_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var CalendarPage = (function (_super) {
        ...
        function CalendarPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'DatePicker');
            return _this;
        }
        CalendarPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Calendar', componentName: 'CalendarExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'Calendar launched from a button', code: CalendarButtonExampleCode },
                        React.createElement(Calendar_Button_Example_1.CalendarButtonExample, null))), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Calendar' }), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "The flyout selector is a light dismiss control. Don't modify this behavior in any way."))), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
        return CalendarPage;
    }(React.Component));
