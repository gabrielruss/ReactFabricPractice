...
define(["require", "exports", "react", "../../components/index", "./examples/Label.Basic.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Label_Basic_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var LabelPage = (function (_super) {
        ...
        function LabelPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Label');
            return _this;
        }
        LabelPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Label', componentName: 'LabelExample', exampleCards: React.createElement(index_1.ExampleCard, { title: 'Label', code: LabelBasicExampleCode },
                    React.createElement(Label_Basic_Example_1.LabelBasicExample, null)), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Label' }), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Don\u2019t use full sentences or complex punctuation (colons, semicolons, etc.)."))), related: React.createElement("a", { href: 'https://dev.office.com/fabric-js/Components/Label/Label.html' }, "Fabric JS"), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
        return LabelPage;
    }(React.Component));
