...
define(["require", "exports", "react", "../../components/index", "./examples/Checkbox.Basic.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Checkbox_Basic_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var CheckboxPage = (function (_super) {
        ...
        CheckboxPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Checkbox', componentName: 'CheckboxExample', exampleCards: React.createElement(index_1.ExampleCard, { title: 'Checkboxes', code: CheckboxBasicExampleCode },
                    React.createElement(Checkbox_Basic_Example_1.CheckboxBasicExample, null)), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Checkbox' }), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Don't put two groups of Checkboxes next to each other. Separate the two groups with labels."))), related: React.createElement("a", { href: 'https://dev.office.com/fabric-js/Components/CheckBox/CheckBox.html' }, "Fabric JS"), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
        return CheckboxPage;
    }(React.Component));
