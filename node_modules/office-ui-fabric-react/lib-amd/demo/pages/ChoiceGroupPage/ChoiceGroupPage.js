...
define(["require", "exports", "react", "../../components/index", "./examples/ChoiceGroup.Basic.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, ChoiceGroup_Basic_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var ChoiceGroupPage = (function (_super) {
        ...
        function ChoiceGroupPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'ChoiceGroup');
            return _this;
        }
        ChoiceGroupPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'ChoiceGroup', componentName: 'ChoiceGroupExample', exampleCards: React.createElement(index_1.ExampleCard, { title: 'ChoiceGroups', code: ChoiceGroupBasicExampleCode },
                    React.createElement(ChoiceGroup_Basic_Example_1.ChoiceGroupBasicExample, null)), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'ChoiceGroup' }), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Nest with other ChoiceGroup or CheckBoxes. If possible, keep all the options at the same level."))), related: React.createElement("a", { href: 'https://dev.office.com/fabric-js/Components/ChoiceFieldGroup/ChoiceFieldGroup.html' }, "Fabric JS"), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
