...
define(["require", "exports", "react", "../../components/index", "../../utilities/pageroute", "../../components/App/AppState", "./examples/ProgressIndicator.Basic.Example"], function (require, exports, React, index_1, pageroute_1, AppState_1, ProgressIndicator_Basic_Example_1) {
    "use strict";
    ...
    var ProgressIndicatorPage = (function (_super) {
        ...
        function ProgressIndicatorPage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'ProgressIndicator');
            return _this;
        }
        ProgressIndicatorPage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'ProgressIndicator', componentName: 'ProgressIndicatorExample', exampleCards: React.createElement(index_1.ExampleCard, { title: 'ProgressIndicator', code: ProgressIndicatorBasicExampleCode },
                    React.createElement(ProgressIndicator_Basic_Example_1.ProgressIndicatorBasicExample, null)), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'ProgressIndicator' }), overview: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Cause progress to \u201Crewind\u201D to show new steps"))), related: React.createElement("a", { href: 'https://dev.office.com/fabric-js/Components/ProgressIndicator/ProgressIndicator.html' }, "Fabric JS"), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
