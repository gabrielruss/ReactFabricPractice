...
define(["require", "exports", "react", "../../components/index", "./examples/Facepile.AddFace.Example", "./examples/Facepile.Basic.Example", "./examples/Facepile.Overflow.Example", "../../utilities/pageroute", "../../components/App/AppState"], function (require, exports, React, index_1, Facepile_AddFace_Example_1, Facepile_Basic_Example_1, Facepile_Overflow_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var FacepilePage = (function (_super) {
        ...
        function FacepilePage() {
            ...
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Facepile');
            return _this;
        }
        FacepilePage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Facepile', componentName: 'FacepileExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'Facepile with Add Face', code: FacepileAddFaceExampleCode },
                        React.createElement(Facepile_AddFace_Example_1.FacepileAddFaceExample, null))), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Facepile' }), overview: React.createElement("div", null,
