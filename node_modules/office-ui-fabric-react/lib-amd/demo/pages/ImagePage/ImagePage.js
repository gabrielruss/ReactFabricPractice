...
define(["require", "exports", "react", "../../components/index", "./examples/Image.Default.Example", "./examples/Image.Center.Example", "./examples/Image.Contain.Example", "./examples/Image.Cover.Example", "./examples/Image.None.Example", "./examples/Image.MaximizeFrame.Example", "../../utilities/pageroute", "../../components/App/AppState", "./ImagePage.scss"], function (require, exports, React, index_1, Image_Default_Example_1, Image_Center_Example_1, Image_Contain_Example_1, Image_Cover_Example_1, Image_None_Example_1, Image_MaximizeFrame_Example_1, pageroute_1, AppState_1) {
    "use strict";
    ...
    var ImageMaximizeFrameExampleCode = require('./examples/Image.MaximizeFrame.Example.tsx');
    var ImagePage = (function (_super) {
        __extends(ImagePage, _super);
        function ImagePage() {
            var _this = _super.call(this) || this;
            _this._url = pageroute_1.getPageRouteFromState(AppState_1.AppState, 'Basic components', 'Image');
            return _this;
        }
        ImagePage.prototype.render = function () {
            return (React.createElement(index_1.ComponentPage, { title: 'Image', componentName: 'ImageExample', exampleCards: React.createElement("div", null,
                    React.createElement(index_1.ExampleCard, { title: 'ImageFit: Not specified', code: ImageDefaultExampleCode },
                    ...
                    React.createElement(index_1.ExampleCard, { title: 'Maximizing the image frame', code: ImageMaximizeFrameExampleCode },
                        React.createElement(Image_MaximizeFrame_Example_1.ImageMaximizeFrameExample, null))), propertiesTables: React.createElement(index_1.PropertiesTableSet, { componentName: 'Image' }), overview: React.createElement("div", null, "Images render an image. The borders have been added to these examples in order to help visualize empty space in the image frame."), route: this._url, isHeaderVisible: this.props.isHeaderVisible }));
        };
        return ImagePage;
    }(React.Component));
