...
define(["require", "exports", "react", "../../../../Utilities", "../../../../index", "../../../../components/DetailsList/DetailsRow", "../../../../utilities/selection/index", "./FocusZone.List.Example.scss"], function (require, exports, React, Utilities_1, index_1, DetailsRow_1, index_2) {
    "use strict";
    ...
    var FocusZoneListExample = (function (_super) {
        ...
        FocusZoneListExample.prototype.render = function () {
            var _this = this;
            return (React.createElement(index_1.FocusZone, { className: 'ms-FocusZoneListExample', direction: index_1.FocusZoneDirection.vertical, isCircularNavigation: true, isInnerZoneKeystroke: function (ev) { return (ev.which === Utilities_1.getRTLSafeKeyCode(Utilities_1.KeyCodes.right)); } }, ITEMS.map(function (item, index) { return (React.createElement(DetailsRow_1.DetailsRow, { key: index, item: item, itemIndex: index, columns: COLUMNS, selectionMode: index_2.SelectionMode.single, selection: _this._selection })); })));
        };
