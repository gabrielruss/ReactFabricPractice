...
export declare const RtFa: string;
export declare const FedAuth: string;
export declare const AdfsOnlineRealm: string;
export declare const OnlineUserRealmEndpoint: string;
